...
class DisplayTab(object):
    ...
    def __init__(self, root_mgr, notebook, index):
        ...
        self.scl_grat_intensity.set_value(self.cfgmgr.Render.GratDefaultIntensity)
    ...
    def _scl_intensity_change(self, *args):
        if self.root_mgr.ctrl.arena != None:
            self.root_mgr.ctrl.arena.set_wave_intensity(self.scl_intensity.get_value() * 0.01) # Value is from 0-100, scale to 0-1
