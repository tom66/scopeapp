...
class ArmwaveRenderEngine(zs.BaseRenderEngine):
    ...
    def __init__(self):
        ...
        for n in range(4):
            ...
            self.channel_palettes[n + 1] = aw.PLT_SINGLE_COLOUR_COMPRESS
    ...
    def render_single_mmal(self, mmal_data_ptr, mmal_trig_buff_ptr):
        if self.xid:
            ...
            aw.set_graticule_colour(self.grat_colour[0] * self.grat_intensity, self.grat_colour[1] * self.grat_intensity, self.grat_colour[2] * self.grat_intensity)
            aw.render_frame_x11()
