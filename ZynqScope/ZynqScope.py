...
"""
timebase_options = [ 50e-9, 100e-9, 200e-9, 500e-9,   1e-6,    2e-6,    5e-6,    10e-6,  20e-6,   50e-6,   100e-6,   
...
class ZynqScope(object):
    ...
    def calculate_nwaves(self, acq_time):
        ...
        return int(max(1, min(625, nwaves)))
